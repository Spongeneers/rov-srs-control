...
# TODO: Define additional Pins as necessary.
...
def main():
    ...
    while True:
        ...
        # Read Pressure value.
        pt_diff = SRS.read_pressure(PIN_PT_IN)

        # Save Pressure value to Log.
        SRS.log_pressure(pt_diff)